...
Public Class getprocesswindow1
...
(ByVal lpClassName As String, ByVal lpWindowName As String) As Integer
    ...
    Private Sub btnadd_Click(sender As Object, e As EventArgs) Handles btnadd.Click
        Dim sameitem As Integer = Mainwindow.cmbtimer.Items.IndexOf(Mainwindow.cmbtimer.Text) 'コンボボックスに同じものがあるか
        If sameitem <> -1 Then 'あったら
            Mainwindow.cmbtimer.Items.Remove(txtprocess.Text)
            Mainwindow.cmbtimer.Items.Insert(0, txtprocess.Text)
            Mainwindow.cmbtimer.SelectedIndex = 0
        Else
            Mainwindow.cmbtimer.Items.Insert(0, txtprocess.Text)
            Mainwindow.cmbtimer.SelectedIndex = 0
        End If

        'Mainwindow.cmbtimer.Items.Add(txtprocess.Text)
        'Mainwindow.cmbtimer.SelectedItem = txtprocess.Text
